# -*- coding: utf-8 -*-
#
# ODCS documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'ODCS.tex', 'ODCS Documentation',
...
man_pages = [
    (master_doc, 'odcs', 'ODCS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ODCS', 'ODCS Documentation',
     author, 'ODCS', 'One line description of project.',
     'Miscellaneous'),
]
